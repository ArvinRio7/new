    ...
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<form method="POST" action="add_song.php">
				...
				<div class="row form-group">
					<div class="col-sm-2">
						<label class="control-label" style="position:relative; top:7px;">Song Author:</label>
					</div>
					<div class="col-sm-10">
						<input type="text" class="form-control" required name="Song_author">
					</div>
				</div>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="publish" class="btn btn-primary"><span class="glyphicon glyphicon-floppy-disk"></span> Upload </a>
			</form>
            </div>
